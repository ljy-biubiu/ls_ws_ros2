...
def generate_launch_description():
    ...
    #cti_vehicle_config_file_path = os.environ['CTI_params_config_PATH'] + "/vehicle.yaml"
    #cti_static_tf_config_file_path = ament_index_python.get_package_share_directory("params_config") + "/config/static_tf.yaml"
    #cti_topic_config_file_path = os.environ['CTI_TF_PATH'] + "/topic_state.yaml"
    return LaunchDescription([
        launch_ros.actions.Node(
            package='params_config', 
            executable='params_config_node', 
            #parameters=[
