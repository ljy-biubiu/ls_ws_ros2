...
private:
    ...
    void lidar_dif_callback(const sensor_msgs::msg::PointCloud2::SharedPtr msg);
    ...
    void electric_relay_control_callback(const std_msgs::msg::Int8MultiArray::SharedPtr &msg);
...
private:
    ...
    rclcpp::Subscription<sensor_msgs::msg::PointCloud2>::SharedPtr lidar_dif_sub;
    rclcpp::Subscription<std_msgs::msg::String>::SharedPtr log_sub;
    rclcpp::Subscription<std_msgs::msg::Int8MultiArray>::SharedPtr electric_relay_control_sub;
    ...
    rclcpp::Publisher<std_msgs::msg::Float64MultiArray>::SharedPtr paint_area_pub_;
...
signals:
    ...
    void emit_lidar_dif(PointCloudTPtr);
    void emit_show_log(QString);
    void emit_lidar_derect_result(QVector<int>);

private slots:
    void saveTopicParams(QString);
    void saveLog(QMultiMap<QString, QString>);
    void getAreaDatas(Area);
    void saveLidarDatas(QVector<QVector<QLineEdit*>>);
};
#endif
